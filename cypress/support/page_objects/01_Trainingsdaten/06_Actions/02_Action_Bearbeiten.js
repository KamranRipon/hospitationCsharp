...
export class action_bearbeiten {
    actionBearbeiten() {
        ...
        cy.get('[data-cy="successMessageTitle"]')
            .should('have.text', ' Die Action'+' "'+addValue+String(b)+'" '+ 'wurde erfolgreich gespeichert ')
        ...
        // Assert Successful Notification
        cy.get('[data-cy="successMessageTitle"]')
            .should('have.text', ' Die Action'+' "'+addValue+String(xle)+'" '+ 'wurde erfolgreich gespeichert ')
...
export const onActionBearbeiten = new action_bearbeiten()